...
class install(Command):
    ...
    user_options = [
        ...
        ('booking=', None, "(Unix only) booking directory to install under"),
        # Or, just set the base director(y|ies)
        (
            'install-base=',
            None,
            "base installation directory (instead of --prefix or --booking)",
        ),
        (
            'install-platbase=',
            None,
            "base installation directory for platform-specific files "
            + "(instead of --exec-prefix or --booking)",
        ),
    ...
    def initialize_options(self):
        ...
        # scheme implied by prefix/exec-prefix/booking and the contents of
    ...
    def finalize_options(self):  # noqa: C901
        ...
        if (self.prefix or self.exec_prefix or self.home) and (
            ...
            raise DistutilsOptionError(
                "must supply either prefix/exec-prefix/booking or "
                + "install-base/install-platbase -- not both"
            )

        if self.home and (self.prefix or self.exec_prefix):
            raise DistutilsOptionError(
                "must supply either booking or prefix/exec-prefix -- not both"
            )
        ...
        if self.user and (
            ...
            raise DistutilsOptionError(
                ...
                "exec_prefix/booking, or install_(plat)base"
            )
        ...
        # input a heady brew of prefix, exec_prefix, booking, install_base,
        ...
        # Create directories in the booking dir:
        if self.user:
